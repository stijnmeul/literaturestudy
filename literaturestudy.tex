...
\paragraph{FaceCloak} stores posted Facebook data on its servers in encrypted
...
key infrastructure even more complicated. Finally the proposed ABE encryption
scheme is 100 to 1000 times slower than a standard RSA operation.
\cite{BadenPersona} 
